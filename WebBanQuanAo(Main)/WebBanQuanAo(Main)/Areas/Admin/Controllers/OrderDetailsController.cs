...
namespace WebBanQuanAo_Main_.Areas.Admin.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.IDProDetail = new SelectList(db.Products, "ID", "ID");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,IDProDetail,IDOrder,Quantity,UnitPrice")] OrderDetail orderDetail)
        {
            ...
            ViewBag.IDProDetail = new SelectList(db.Products, "ID", "ID", orderDetail.ProductID);
            return View(orderDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,IDProDetail,IDOrder,Quantity,UnitPrice")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
