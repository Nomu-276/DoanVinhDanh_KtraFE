...
namespace WebBanQuanAo_Main_.Areas.Admin.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDSup,NameSup,AddressSup")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDSup,NameSup,AddressSup")] Supplier supplier)
        {
            if (ModelState.IsValid)
            {
